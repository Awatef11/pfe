...
class FormationController extends Controller
{
    ...
    public function choixAction(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            var_dump($request);
            die('votre choix est enregistree');
        }

        $em = $this->getDoctrine()->getManager();
        $formations = $em->getRepository('gestionBundle:Formation')->findAll();
        return $this->render('formation/choix.html.twig', array('formations'=>$formations));
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('mdw\gestionBundle\Form\FormationType', $formation);
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('mdw\gestionBundle\Form\FormationType', $formation);
